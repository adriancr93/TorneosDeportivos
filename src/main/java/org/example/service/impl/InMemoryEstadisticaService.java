...
public class InMemoryEstadisticaService implements IEstadisticaService {
    private final Map<String, Estadistica> estadisticas = new HashMap<>();
    private final InMemoryPartidoService partidoService;
    private final InMemoryJugadorService jugadorService;

    public InMemoryEstadisticaService(InMemoryPartidoService partidoService, InMemoryJugadorService jugadorService) {
    ...
    public Estadistica generarEstadisticas(String torneoId) {
        ...
        List<TablaPosicionItem> tabla = stats.entrySet().stream()
                ...
                .sorted((a, b) -> b.getPuntos() - a.getPuntos())
        ...
        estadisticas.put(torneoId, est);
        return est;
    }

    @Override
    public Estadistica visualizarEstadisticas(String torneoId) {
        return estadisticas.get(torneoId);
    }
}
