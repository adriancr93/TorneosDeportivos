  ...
  return (
    <>
      ...
      <aside
        ...
        } overflow-y-auto border-r border-[#dfe5ef] bg-white text-[#2a3547] transition-colors dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100`}
      >
        <div className="sticky top-0 border-b border-[#eef2f8] bg-white px-6 py-5 transition-colors dark:border-slate-800 dark:bg-slate-950">
          <div className="flex items-start gap-3">
            ...
            <div className="pt-2">
              ...
              <h1 className="mt-1 text-base font-bold text-[#2a3547] dark:text-slate-100">Admin Dashboard</h1>
            </div>
            <button
              onClick={onClose}
              className="ml-auto text-2xl text-[#5a6a85] hover:text-[#2a3547] dark:text-slate-400 dark:hover:text-slate-100 lg:hidden"
            >
              ✕
            </button>
          </div>
        ...
        <div className="mx-4 mt-4 rounded-lg bg-[#eef3ff] p-4 transition-colors dark:bg-slate-900">
          <div className="flex items-center gap-3">
            <img src={rocketImage} alt="Promo" className="h-12 w-12 shrink-0" />
            <div>
              <p className="text-xs font-semibold text-[#2a3547] dark:text-slate-100">Panel listo</p>
              <p className="mt-1 text-xs text-[#5a6a85] dark:text-slate-400">Gestiona todas las categorías</p>
            </div>
          </div>
        </div>

        <div className="px-6 pt-6 pb-2 text-[11px] font-bold uppercase tracking-[0.2em] text-[#7a8ca8] dark:text-slate-500">Menu</div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `group rounded-lg border px-4 py-2.5 transition-all ${
                  isActive
                    ? 'border-[#d6e2ff] bg-[#eef3ff] text-[#2a3547] dark:border-sky-500/30 dark:bg-slate-900 dark:text-slate-100'
                    : 'border-transparent text-[#5a6a85] hover:border-[#e8eef8] hover:bg-[#f8fbff] hover:text-[#2a3547] dark:text-slate-400 dark:hover:border-slate-700 dark:hover:bg-slate-900 dark:hover:text-slate-100'
                }`
              }
            >
              <div className="flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-md bg-[#f4f7fd] text-[#5d87ff] transition-colors dark:bg-slate-800 dark:text-sky-300">{item.icon}</span>
                <div>
        ...
        <div className="mt-auto border-t border-[#eef2f8] px-5 py-4 text-xs text-[#7a8ca8] transition-colors dark:border-slate-800 dark:text-slate-500">
